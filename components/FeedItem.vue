<template>
  <li
    role="article"
    class="relative pl-6 before:absolute before:left-0 before:top-2 before:z-10 before:h-2 before:w-2 before:-translate-x-1/2 before:rounded-full before:bg-blue before:ring-2 before:ring-white lg:flex lg:gap-12 lg:pl-0 lg:before:-left-[2.5rem] lg:left-[4rem] md:w-[90%]"
  >
    <div class="flex flex-col flex-1 gap-3">
      <div class="flex flex-col">
        <h4 class="flex flex-col md:flex-row text-md md:text-lg leading-7">
