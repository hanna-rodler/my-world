  ...
  <div class="container-plain my-10">
    ...
    <div class="impressum">
      ...
      <div>
        ...
        <div>
          Hanna Julia Rodler<br />
          Beethovenstr. 24<br />
          4020 Linz<br />
          haj.rodler@gmail.com
        </div>
        <div>
          <b>Urheberrecht:</b>
          <div>
        ...
        <div>
          ...
          <div>
            ...
            dieser Webseite verantwortlich. Durch §§ 8 bis einschließlich 10 TMG
            sind wir aber nicht verpflichtet, gespeicherte oder übermittelte
            fremde Inhalte zu überwachen oder diese auf Rechtswidrigkeit zu
            prüfen. Das befreit uns jedoch nicht von der Pflicht, der Sperrung
            und Entfernung von Informationen nach geltenden Gesetzen
            nachzukommen.
          </div>
        </div>
        <div>
          ...
          <div>
            ...
            dieser Webseite mit größter Sorgfalt beachtet. Sollten Sie trotzdem
